            ...
            <Form action='/' className='auth-register-form mt-2' onSubmit={handleSubmit(onSubmit)}>
              <div className='mb-1'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input autoFocus placeholder='abcCompany' invalid={errors.companyname && true} {...field} />
                  )}
                />
                {errors.companyname ? <FormFeedback>{errors.companyname.message}</FormFeedback> : null}
              </div>
              <div className='mb-1'>
